...
class CameraImagePublisherFlatZc :
  public BaseCameraImagePublisherFlatZc<rti::camera::flat_zc::CameraImage>
{
public:
...
RCLCPP_COMPONENTS_REGISTER_NODE(rti::connext_nodes_cpp::camera::CameraImagePublisherFlatZc)
